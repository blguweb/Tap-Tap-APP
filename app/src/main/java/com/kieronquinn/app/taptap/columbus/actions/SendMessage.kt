...
class SendMessage(context: Context) : ActionBase(context) {
...
//            context.startActivity(launchIntent)
            ...
            var sm = getIMU()
            if(sm != ""){
                if(mBluetooth.startcalibration == 1){
                    mBluetooth.funBlueClientSend(mBluetooth.equipment + " " + sm)
                }
                else if(mBluetooth.startcalibration == 2){
                    mBluetooth.funBlueClientSend(mBluetooth.equipment + " " + sm+ " " + "2")
                }
                else{
